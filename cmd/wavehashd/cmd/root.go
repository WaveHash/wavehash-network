...
import (
	...
	"github.com/WaveHashProtocol/wavehash/v6/app/params"
)

// NewRootCmd creates a new root command for wavehashd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		Use:   version.AppName,
		Short: "Wavehash Smart Contract Zone",
...
func SetCustomEnvVariablesFromClientToml(ctx client.Context) {
	...
	// gas
	setEnvFromConfig("gas", "WAVEHASHD_GAS")
	setEnvFromConfig("gas-prices", "WAVEHASHD_GAS_PRICES")
	setEnvFromConfig("gas-adjustment", "WAVEHASHD_GAS_ADJUSTMENT")
	// fees
	setEnvFromConfig("fees", "WAVEHASHD_FEES")
	setEnvFromConfig("fee-account", "WAVEHASHD_FEE_ACCOUNT")
	// memo
	setEnvFromConfig("note", "WAVEHASHD_NOTE")
}
...
func (ac appCreator) appExport(
	...
	if height != -1 {
		if err := wavehashApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	}

	return wavehashApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
