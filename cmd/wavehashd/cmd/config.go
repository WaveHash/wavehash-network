...
type WavehashCustomClient struct {
...
func runConfigCmd(cmd *cobra.Command, args []string) error {
	...
	jcc := WavehashCustomClient{
		*conf,
		os.Getenv("WAVEHASHD_GAS"),
		os.Getenv("WAVEHASHD_GAS_PRICES"),
		os.Getenv("WAVEHASHD_GAS_ADJUSTMENT"),

		os.Getenv("WAVEHASHD_FEES"),
		os.Getenv("WAVEHASHD_FEE_ACCOUNT"),

		os.Getenv("WAVEHASHD_NOTE"),
	}
...
###############################################################################
###                          Wavehash Tx Configuration                          ###
###############################################################################

# Amount of gas per transaction
gas = "{{ .Gas }}"
# Price per unit of gas (ex: 0.005uwaha)
...
// configFilePath.
func writeConfigToFile(configFilePath string, config *WavehashCustomClient) error {
