module github.com/WaveHashProtocol/wavehash/tests/interchaintest
...
replace (
	...
	// token factory:
	github.com/CosmWasm/token-factory => github.com/WaveHashProtocol/token-factory v0.0.0-20230226045138-fb4138453558

	// For this nested module, you always want to replace the parent reference with the current worktree.
	github.com/WaveHashProtocol/wavehash => ../../	
...
require (
	github.com/WaveHashProtocol/wavehash/v6 v6.0.0
