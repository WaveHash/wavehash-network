...
import (
	...
	mintkeeper "github.com/WaveHashProtocol/wavehash/v6/x/mint/keeper"
	minttypes "github.com/WaveHashProtocol/wavehash/v6/x/mint/types"
	...
	feesharekeeper "github.com/WaveHashProtocol/wavehash/v6/x/feeshare/keeper"
...
func NewAppKeepers(
	...
	wavehashPrefix := sdk.GetConfig().GetBech32AccountAddrPrefix()
	wasmHooks := ibchooks.NewWasmHooks(appKeepers.IBCHooksKeeper, nil, wavehashPrefix) // The contract keeper needs to be set later
