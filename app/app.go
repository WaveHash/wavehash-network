...
import (
	...
	"github.com/WaveHashProtocol/wavehash/v6/app/openapiconsole"
	"github.com/WaveHashProtocol/wavehash/v6/docs"
	...
	encparams "github.com/WaveHashProtocol/wavehash/v6/app/params"
	upgrades "github.com/WaveHashProtocol/wavehash/v6/app/upgrades"
	v1 "github.com/WaveHashProtocol/wavehash/v6/app/upgrades/v1"
	v2 "github.com/WaveHashProtocol/wavehash/v6/app/upgrades/v2"
	v3 "github.com/WaveHashProtocol/wavehash/v6/app/upgrades/v3"
	v4 "github.com/WaveHashProtocol/wavehash/v6/app/upgrades/v4"
	v5 "github.com/WaveHashProtocol/wavehash/v6/app/upgrades/v5"
	v6 "github.com/WaveHashProtocol/wavehash/v6/app/upgrades/v6"
)

const (
	AccountAddressPrefix = "wavehash"
	Name                 = "wavehash"
)
...
var (
	...
	Upgrades = []upgrades.Upgrade{v1.Upgrade, v2.Upgrade, v3.Upgrade, v4.Upgrade, v5.Upgrade, v6.Upgrade}
)
...
// any overrides above
var (
	// DefaultNodeHome default home directories for Wavehash
...
func GetWasmOpts(appOpts servertypes.AppOptions) []wasm.Option {
	...
	wasmOpts = append(wasmOpts, wasmkeeper.WithGasRegister(NewWavehashWasmGasRegister()))
...
// New returns a reference to an initialized Wavehash.
func New(
	logger log.Logger,
	db dbm.DB,
...
// AppCodec returns Wavehash's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns Wavehash's InterfaceRegistry
